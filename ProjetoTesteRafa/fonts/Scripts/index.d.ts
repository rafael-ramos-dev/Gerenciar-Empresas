...
declare namespace Popper {
  export type PoProjetoTesteRafaion = 'top' | 'right' | 'bottom' | 'left';
  ...
  export interface Modifiers {
    ...
    preventOverflow?: BaseModifier & {
      priority?: PoProjetoTesteRafaion[],
    ...
    flip?: BaseModifier & {
      behavior?: Behavior | PoProjetoTesteRafaion[],
      padding?: number | Padding,
      boundariesElement?: Boundary | Element,
  ...
  export interface PopperOptions {
    placement?: Placement;
    poProjetoTesteRafaionFixed?: boolean;
...
export type PoProjetoTesteRafaion = Popper.PoProjetoTesteRafaion;

...
<p align="center">
    <strong>A library used to poProjetoTesteRafaion poppers in web applications.</strong>
</p>
...
Well, basically, **no**.  
Popper.js is a **poProjetoTesteRafaioning engine**, its purpose is to calculate the poProjetoTesteRafaion of an element
to make it possible to poProjetoTesteRafaion it near a given reference element.  
...
- PoProjetoTesteRafaion elements keeping them in their original DOM context (doesn't mess with your DOM!);
- Allows to export the computed informations to integrate with React and other view libraries;
- Supports Shadow DOM elements;
- Completely customizable thanks to the modifiers based structure;

ViProjetoTesteRafa our [project page](https://fezvrasta.github.io/popper.js) to see a lot of examples of what you can do with Popper.js!
...
Given an existing popper DOM node, ask Popper.js to poProjetoTesteRafaion it near its button
...
A modifier is a function that is called each time Popper.js needs to compute the poProjetoTesteRafaion of the popper. For this reason, modifiers should be very performant to avoid bottlenecks.  
...
frameworks, viProjetoTesteRafa the [MENTIONS](/MENTIONS.md) page.
...
Popper.js is very performant. It usually takes 0.5ms to compute a popper's poProjetoTesteRafaion (on an iMac with 3.5G GHz Intel Core i5).  
...
The aim of Popper.js is to provide a stable and powerful poProjetoTesteRafaioning engine ready to
be used in 3rd party libraries.  

ViProjetoTesteRafa the [MENTIONS](/MENTIONS.md) page for an updated list of projects.
...
- [Tether.js](http://github.hubspot.com/tether/) for having inspired me in writing a poProjetoTesteRafaioning library ready for the real world;
